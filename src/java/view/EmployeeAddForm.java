...
public class EmployeeAddForm extends HttpServlet {
    ...
    private void addEmployee(Map<String, String[]> values) {
        ...
        Title title = new Title(
                ...
                Date.valueOf(values.get(Title.COL_FROM_DATE)[1]),
                Date.valueOf(values.get(Title.COL_TO_DATE)[1]));
        ...
        if(values.get("DepartmentManager") != null)
        {
            DepartmentManager deptMan = new DepartmentManager(
                    ...
                    Date.valueOf(values.get(DepartmentManager.COL_FROM_DATE)[3]),
                    Date.valueOf(values.get(DepartmentManager.COL_TO_DATE)[3]));
